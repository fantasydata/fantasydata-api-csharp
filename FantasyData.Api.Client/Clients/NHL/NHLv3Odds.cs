...
namespace FantasyData.Api.Client
{
    public partial class NHLv3OddsClient : BaseClient
    {
        ...
        /// </summary>
        /// <param name="date">The date of the game(s). Examples: <code>2018-11-20</code>, <code>2018-11-23</code>.</param>
        public Task<List<GameInfo>> GetPreGameOddsByDate_701Async(string date)
        {
            var parameters = new List<KeyValuePair<string, string>>();
            parameters.Add(new KeyValuePair<string, string>("date", date.ToString()));
            return Task.Run<List<GameInfo>>(() =>
        ...
        /// </summary>
        /// <param name="date">The date of the game(s). Examples: <code>2018-11-20</code>, <code>2018-11-23</code>.</param>
        public List<GameInfo> GetPreGameOddsByDate_701(string date)
        {
            return this.GetPreGameOddsByDate_701Async(date).Result;
        }
