...
namespace FantasyData.Api.Client
{
    public partial class NHLv3ScoresClient : BaseClient
    {
        ...
        public Task<List<TeamGame>> GetTeamGameLogsBySeasonAsync(string season, int teamid, string numberofgames)
        {
            ...
            return Task.Run<List<TeamGame>>(() =>
                base.Get<List<TeamGame>>("/v3/nhl/scores/{format}/TeamGameStatsBySeason/{season}/{teamid}/{numberofgames}", parameters)
            );
        }
        ...
        public Task<List<ScoreBasic>> GetGamesBasicByDateLiveFinalAsync(string date)
        {
            ...
            return Task.Run<List<ScoreBasic>>(() =>
                base.Get<List<ScoreBasic>>("/v3/nhl/scores/{format}/ScoresBasic/{date}", parameters)
            );
        }
        ...
        public Task<List<PlayerBasic>> GetPlayersProfilesByTeamAsync(string team)
        {
            ...
            return Task.Run<List<PlayerBasic>>(() =>
                base.Get<List<PlayerBasic>>("/v3/nhl/scores/{format}/PlayersBasic/{team}", parameters)
            );
        }
        ...
        public Task<List<ScheduleBasic>> GetSchedulesBasicAsync(string season)
        {
            ...
            return Task.Run<List<ScheduleBasic>>(() =>
                base.Get<List<ScheduleBasic>>("/v3/nhl/scores/{format}/SchedulesBasic/{season}", parameters)
            );
        }
        ...
        /// Get Player Details - by Active Asynchronous
        /// </summary>
        public Task<List<PlayerBasic>> GetPlayerDetailsByActive_1462Async()
        {
            var parameters = new List<KeyValuePair<string, string>>();
            return Task.Run<List<PlayerBasic>>(() =>
                base.Get<List<PlayerBasic>>("/v3/nhl/scores/{format}/PlayersByActive", parameters)
            );
        }
        ...
        /// Get Player Details - by Active
        /// </summary>
        public List<PlayerBasic> GetPlayerDetailsByActive_1462()
        {
            return this.GetPlayerDetailsByActive_1462Async().Result;
        }

        /// <summary>
        /// Get Player Details - by Free Agents Asynchronous
        /// </summary>
        public Task<List<PlayerBasic>> GetPlayerDetailsByFreeAgents_1463Async()
        {
            var parameters = new List<KeyValuePair<string, string>>();
            return Task.Run<List<PlayerBasic>>(() =>
                base.Get<List<PlayerBasic>>("/v3/nhl/scores/{format}/PlayersByFreeAgents", parameters)
            );
        }
        ...
        /// Get Player Details - by Free Agents
        /// </summary>
        public List<PlayerBasic> GetPlayerDetailsByFreeAgents_1463()
        {
            return this.GetPlayerDetailsByFreeAgents_1463Async().Result;
        }

        /// <summary>
        /// Get Depth Charts - Goalies Asynchronous
        /// </summary>
        public Task<List<TeamGoalieDepthChart>> GetDepthChartsGoaliesAsync()
        {
            var parameters = new List<KeyValuePair<string, string>>();
            return Task.Run<List<TeamGoalieDepthChart>>(() =>
                base.Get<List<TeamGoalieDepthChart>>("/v3/nhl/scores/{format}/GoalieDepthCharts", parameters)
            );
        }
        ...
        /// </summary>
        public List<TeamGoalieDepthChart> GetDepthChartsGoalies()
        {
            return this.GetDepthChartsGoaliesAsync().Result;
        }
        ...
        public Task<List<Transaction>> GetTransactionsAsync(string date)
        {
            ...
            return Task.Run<List<Transaction>>(() =>
                base.Get<List<Transaction>>("/v3/nhl/scores/{format}/TransactionsByDate/{date}", parameters)
            );
        }
        ...
        public Task<List<Team>> GetTeamProfilesBySeasonAsync(string season)
        {
            ...
            parameters.Add(new KeyValuePair<string, string>("season", season.ToString()));
            return Task.Run<List<Team>>(() =>
                base.Get<List<Team>>("/v3/nhl/scores/{format}/teams/{season}", parameters)
            );
        }
        ...
        public Task<List<Game>> GetGamesByDateFinalAsync(string date)
        {
            ...
            parameters.Add(new KeyValuePair<string, string>("date", date.ToString()));
            return Task.Run<List<Game>>(() =>
                base.Get<List<Game>>("/v3/nhl/scores/{format}/GamesByDateFinal/{date}", parameters)
            );
        }
        ...
        public Task<List<ScoreBasic>> GetGamesBasicByDateFinalAsync(string date)
        {
            ...
            parameters.Add(new KeyValuePair<string, string>("date", date.ToString()));
            return Task.Run<List<ScoreBasic>>(() =>
                base.Get<List<ScoreBasic>>("/v3/nhl/scores/{format}/ScoresBasicFinal/{date}", parameters)
            );
        }
