...
namespace FantasyData.Api.Client
{
    public partial class NBAv2Client : BaseClient
    {
        ...
        public bool GetAreAnyGamesInProgress()
        {
            ...
            return base.Get<bool>("/nba/v2/{format}/AreAnyGamesInProgress", parameters);
        }
        ...
        public BoxScore GetBoxScore(int gameid)
        {
            ...
            return base.Get<BoxScore>("/nba/v2/{format}/BoxScore/{gameid}", parameters);
        }
        ...
        public List<BoxScore> GetBoxScores(string date)
        {
            ...
            return base.Get<List<BoxScore>>("/nba/v2/{format}/BoxScores/{date}", parameters);
        }
        ...
        public List<BoxScore> GetBoxScoresDelta(string date, string minutes)
        {
            ...
            return base.Get<List<BoxScore>>("/nba/v2/{format}/BoxScoresDelta/{date}/{minutes}", parameters);
        }
        ...
        {
            var parameters = new List<KeyValuePair<string, string>>();
            return base.Get<List<Season>>("/nba/v2/{format}/CurrentSeason", parameters);
        }
        ...
        public List<Game> GetGamesByDate(string date)
        {
            var parameters = new List<KeyValuePair<string, string>>();
            parameters.Add(new KeyValuePair<string, string>("date", date.ToString()));
            return base.Get<List<Game>>("/nba/v2/{format}/GamesByDate/{date}", parameters);
        }
        ...
        {
            var parameters = new List<KeyValuePair<string, string>>();
            return base.Get<List<News>>("/nba/v2/{format}/News", parameters);
        }
        ...
        public List<News> GetNewsByDate(string date)
        {
            var parameters = new List<KeyValuePair<string, string>>();
            parameters.Add(new KeyValuePair<string, string>("date", date.ToString()));
            return base.Get<List<News>>("/nba/v2/{format}/NewsByDate/{date}", parameters);
        }
        ...
        public List<News> GetNewsByPlayerID(int playerid)
        {
            ...
            return base.Get<List<News>>("/nba/v2/{format}/NewsByPlayerID/{playerid}", parameters);
        }
        ...
        {
            var parameters = new List<KeyValuePair<string, string>>();
            return base.Get<List<Player>>("/nba/v2/{format}/Players", parameters);
        }
        ...
        {
            var parameters = new List<KeyValuePair<string, string>>();
            return base.Get<List<Player>>("/nba/v2/{format}/FreeAgents", parameters);
        }
        ...
        public Player GetPlayer(int playerid)
        {
            var parameters = new List<KeyValuePair<string, string>>();
            parameters.Add(new KeyValuePair<string, string>("playerid", playerid.ToString()));
            return base.Get<Player>("/nba/v2/{format}/Player/{playerid}", parameters);
        }
        ...
        public List<PlayerGame> GetPlayerGameStatsByDate(string date)
        {
            var parameters = new List<KeyValuePair<string, string>>();
            parameters.Add(new KeyValuePair<string, string>("date", date.ToString()));
            return base.Get<List<PlayerGame>>("/nba/v2/{format}/PlayerGameStatsByDate/{date}", parameters);
        }
        ...
        public PlayerGame GetPlayerGameStatsByPlayer(string date, int playerid)
        {
            ...
            parameters.Add(new KeyValuePair<string, string>("date", date.ToString()));
            parameters.Add(new KeyValuePair<string, string>("playerid", playerid.ToString()));
            return base.Get<PlayerGame>("/nba/v2/{format}/PlayerGameStatsByPlayer/{date}/{playerid}", parameters);
        }
        ...
        public List<PlayerSeason> GetPlayerSeasonStats(string season)
        {
            ...
            return base.Get<List<PlayerSeason>>("/nba/v2/{format}/PlayerSeasonStats/{season}", parameters);
        }
        ...
        public PlayerSeason GetPlayerSeasonStatsByPlayer(string season, int playerid)
        {
            ...
            parameters.Add(new KeyValuePair<string, string>("season", season.ToString()));
            parameters.Add(new KeyValuePair<string, string>("playerid", playerid.ToString()));
            return base.Get<PlayerSeason>("/nba/v2/{format}/PlayerSeasonStatsByPlayer/{season}/{playerid}", parameters);
        }
        ...
        public List<PlayerSeason> GetPlayerSeasonStatsByTeam(string season, string team)
        {
            ...
            return base.Get<List<PlayerSeason>>("/nba/v2/{format}/PlayerSeasonStatsByTeam/{season}/{team}", parameters);
        }
        ...
        public List<Player> GetPlayers(string team)
        {
            var parameters = new List<KeyValuePair<string, string>>();
            parameters.Add(new KeyValuePair<string, string>("team", team.ToString()));
            return base.Get<List<Player>>("/nba/v2/{format}/Players/{team}", parameters);
        }
        ...
        public List<PlayerGameProjection> GetPlayerGameProjectionStatsByDate(string date)
        {
            var parameters = new List<KeyValuePair<string, string>>();
            parameters.Add(new KeyValuePair<string, string>("date", date.ToString()));
            return base.Get<List<PlayerGameProjection>>("/nba/v2/{format}/PlayerGameProjectionStatsByDate/{date}", parameters);
        }
        ...
        public PlayerGameProjection GetPlayerGameProjectionStatsByPlayer(string date, int playerid)
        {
            ...
            parameters.Add(new KeyValuePair<string, string>("date", date.ToString()));
            parameters.Add(new KeyValuePair<string, string>("playerid", playerid.ToString()));
            return base.Get<PlayerGameProjection>("/nba/v2/{format}/PlayerGameProjectionStatsByPlayer/{date}/{playerid}", parameters);
        }
        ...
        public List<Game> GetGames(string season)
        {
            var parameters = new List<KeyValuePair<string, string>>();
            parameters.Add(new KeyValuePair<string, string>("season", season.ToString()));
            return base.Get<List<Game>>("/nba/v2/{format}/Games/{season}", parameters);
        }
        ...
        {
            var parameters = new List<KeyValuePair<string, string>>();
            return base.Get<List<Stadium>>("/nba/v2/{format}/Stadiums", parameters);
        }
        ...
        public List<Standing> GetStandings(string season)
        {
            var parameters = new List<KeyValuePair<string, string>>();
            parameters.Add(new KeyValuePair<string, string>("season", season.ToString()));
            return base.Get<List<Standing>>("/nba/v2/{format}/Standings/{season}", parameters);
        }
        ...
        public List<TeamGame> GetTeamGameStatsByDate(string date)
        {
            var parameters = new List<KeyValuePair<string, string>>();
            parameters.Add(new KeyValuePair<string, string>("date", date.ToString()));
            return base.Get<List<TeamGame>>("/nba/v2/{format}/TeamGameStatsByDate/{date}", parameters);
        }
        ...
        public List<TeamSeason> GetTeamSeasonStats(string season)
        {
            var parameters = new List<KeyValuePair<string, string>>();
            parameters.Add(new KeyValuePair<string, string>("season", season.ToString()));
            return base.Get<List<TeamSeason>>("/nba/v2/{format}/TeamSeasonStats/{season}", parameters);
        }
        ...
        public List<TeamSeason> GetTeamStatsAllowedByPosition(string season)
        {
            var parameters = new List<KeyValuePair<string, string>>();
            parameters.Add(new KeyValuePair<string, string>("season", season.ToString()));
            return base.Get<List<TeamSeason>>("/nba/v2/{format}/TeamStatsAllowedByPosition/{season}", parameters);
        }
        ...
        {
            var parameters = new List<KeyValuePair<string, string>>();
            return base.Get<List<Team>>("/nba/v2/{format}/teams", parameters);
        }
        ...
        {
            var parameters = new List<KeyValuePair<string, string>>();
            return base.Get<List<Team>>("/nba/v2/{format}/AllTeams", parameters);
        }
