...
namespace FantasyData.Api.Client
{
    public partial class NBAv3RotoBallerPremiumNewsClient : BaseClient
    {
        ...
        public List<News> GetRotoBallerPremiumNews()
        {
            ...
            return base.Get<List<News>>("/v3/nba/news-rotoballer/{format}/RotoBallerPremiumNews", parameters);
        }
        ...
        public List<News> GetRotoBallerPremiumNewsByDate(string date)
        {
            ...
            return base.Get<List<News>>("/v3/nba/news-rotoballer/{format}/RotoBallerPremiumNewsByDate/{date}", parameters);
        }
        ...
        public List<News> GetRotoBallerPremiumNewsByPlayerID(int playerid)
        {
            ...
            return base.Get<List<News>>("/v3/nba/news-rotoballer/{format}/RotoBallerPremiumNewsByPlayerID/{playerid}", parameters);
        }
