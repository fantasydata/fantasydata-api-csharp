...
namespace FantasyData.Api.Client
{
    public partial class NBAv3StatsClient : BaseClient
    {
        ...
        /// <summary>
        /// Get Player Details by Team - Legacy Asynchronous
        /// </summary>
        /// <param name="team">The abbreviation of the requested team. Examples: <code>PHI</code>, <code>BKN</code>.</param>
        public Task<List<Player>> GetPlayerDetailsByTeamLegacyAsync(string team)
        {
            var parameters = new List<KeyValuePair<string, string>>();
            parameters.Add(new KeyValuePair<string, string>("team", team.ToString()));
            return Task.Run<List<Player>>(() =>
        ...
        /// </summary>
        /// <param name="team">The abbreviation of the requested team. Examples: <code>PHI</code>, <code>BKN</code>.</param>
        public List<Player> GetPlayerDetailsByTeamLegacy(string team)
        {
            return this.GetPlayerDetailsByTeamLegacyAsync(team).Result;
        }
