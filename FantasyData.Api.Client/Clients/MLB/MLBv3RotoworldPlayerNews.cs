...
{
    public partial class MLBv3RotoworldPlayerNewsClient : BaseClient
    {
        public MLBv3RotoworldPlayerNewsClient(string apiKey) : base(apiKey) { }
        public MLBv3RotoworldPlayerNewsClient(Guid apiKey) : base(apiKey) { }
        ...
        public Task<List<RotoworldPlayerNewsItem>> GetRotoworldPlayerNewsByRecentAsync()
        {
            ...
            return Task.Run<List<RotoworldPlayerNewsItem>>(() =>
                base.Get<List<RotoworldPlayerNewsItem>>("/v3/mlb/rotoworld/{format}/RotoworldPlayerNews", parameters)
            );
        }
        ...
        public Task<List<RotoworldPlayerNewsItem>> GetRotoworldPlayerNewsByDateAsync(string date)
        {
            ...
            return Task.Run<List<RotoworldPlayerNewsItem>>(() =>
                base.Get<List<RotoworldPlayerNewsItem>>("/v3/mlb/rotoworld/{format}/RotoworldPlayerNewsByDate/{date}", parameters)
            );
        }
