...
namespace FantasyData.Api.Client
{
    public partial class MLBv3OddsClient : BaseClient
    {
        ...
        public Task<List<BettingEvent>> GetBettingPlayerPropsByDateAsync(string date)
        {
            ...
            parameters.Add(new KeyValuePair<string, string>("date", date.ToString()));
            return Task.Run<List<BettingEvent>>(() =>
                base.Get<List<BettingEvent>>("/v3/mlb/odds/{format}/BettingPlayerPropsByDate/{date}", parameters)
            );
        }
        ...
        public Task<List<BettingEntityMetadata>> GetBettingMetadataAsync()
        {
            ...
            return Task.Run<List<BettingEntityMetadata>>(() =>
                base.Get<List<BettingEntityMetadata>>("/v3/mlb/odds/{format}/BettingMetadata", parameters)
            );
        }
