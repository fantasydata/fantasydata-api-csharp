...
namespace FantasyData.Api.Client
{
    public partial class NFLv3RotoBallerArticlesClient : BaseClient
    {
        ...
        public List<Article> GetRotoBallerArticles()
        {
            ...
            return base.Get<List<Article>>("/v3/nfl/articles-rotoballer/{format}/RotoBallerArticles", parameters);
        }
        ...
        public List<Article> GetRotoBallerArticlesByDate(string date)
        {
            ...
            return base.Get<List<Article>>("/v3/nfl/articles-rotoballer/{format}/RotoBallerArticlesByDate/{date}", parameters);
        }
        ...
        public List<Article> GetRotoBallerArticlesByPlayerID(int playerid)
        {
            ...
            return base.Get<List<Article>>("/v3/nfl/articles-rotoballer/{format}/RotoBallerArticlesByPlayerID/{playerid}", parameters);
        }
