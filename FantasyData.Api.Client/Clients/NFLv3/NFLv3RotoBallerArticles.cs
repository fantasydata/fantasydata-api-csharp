    ...
    public partial class NFLv3RotoBallerArticlesClient : BaseClient
    {
        ...
        public Task<List<Article>> GetRotoBallerArticlesAsync()
        {
            ...
            return Task.Run<List<Article>>(() =>
                base.Get<List<Article>>("/v3/nfl/articles-rotoballer/{format}/RotoBallerArticles", parameters)
            );
        }
        ...
        public Task<List<Article>> GetRotoBallerArticlesByDateAsync(string date)
        {
            ...
            return Task.Run<List<Article>>(() =>
                base.Get<List<Article>>("/v3/nfl/articles-rotoballer/{format}/RotoBallerArticlesByDate/{date}", parameters)
            );
        }
        ...
        public Task<List<Article>> GetRotoBallerArticlesByPlayerAsync(int playerid)
        {
            ...
            return Task.Run<List<Article>>(() =>
                base.Get<List<Article>>("/v3/nfl/articles-rotoballer/{format}/RotoBallerArticlesByPlayerID/{playerid}", parameters)
            );
        }
