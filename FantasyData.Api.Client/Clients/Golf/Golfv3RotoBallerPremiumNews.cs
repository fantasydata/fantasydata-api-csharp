...
{
    public partial class Golfv3RotoBallerPremiumNewsClient : BaseClient
    {
        public Golfv3RotoBallerPremiumNewsClient(string apiKey) : base(apiKey) { }
        public Golfv3RotoBallerPremiumNewsClient(Guid apiKey) : base(apiKey) { }
        ...
        public Task<List<News>> GetPremiumNewsAsync()
        {
            ...
            return Task.Run<List<News>>(() =>
                base.Get<List<News>>("/v3/golf/news-rotoballer/{format}/RotoBallerPremiumNews", parameters)
            );
        }
        ...
        public Task<List<News>> GetPremiumNewsByDateAsync(string date)
        {
            ...
            return Task.Run<List<News>>(() =>
                base.Get<List<News>>("/v3/golf/news-rotoballer/{format}/RotoBallerPremiumNewsByDate/{date}", parameters)
            );
        }
        ...
        public Task<List<News>> GetPremiumNewsByPlayerAsync(int playerid)
        {
            ...
            return Task.Run<List<News>>(() =>
                base.Get<List<News>>("/v3/golf/news-rotoballer/{format}/RotoBallerPremiumNewsByPlayerID/{playerid}", parameters)
            );
        }
