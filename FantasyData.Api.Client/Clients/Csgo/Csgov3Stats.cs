    ...
    public partial class Csgov3StatsClient : BaseClient
    {
        ...
        public Task<List<Area>> GetAreasCountriesAsync()
        {
            ...
            return Task.Run<List<Area>>(() =>
                base.Get<List<Area>>("/v3/csgo/stats/{format}/Areas", parameters)
            );
        }
        ...
        public Task<List<BoxScore>> GetBoxScoreAsync(int gameid)
        {
            ...
            return Task.Run<List<BoxScore>>(() =>
                base.Get<List<BoxScore>>("/v3/csgo/stats/{format}/BoxScore/{gameid}", parameters)
            );
        }
        ...
        public Task<List<BoxScore>> GetBoxScoresByDateAsync(string date)
        {
            ...
            return Task.Run<List<BoxScore>>(() =>
                base.Get<List<BoxScore>>("/v3/csgo/stats/{format}/BoxScores/{date}", parameters)
            );
        }
        ...
        public Task<CompetitionDetail> GetCompetitionFixturesLeagueDetailsAsync(string competitionid)
        {
            ...
            return Task.Run<CompetitionDetail>(() =>
                base.Get<CompetitionDetail>("/v3/csgo/stats/{format}/CompetitionDetails/{competitionid}", parameters)
            );
        }
        ...
        public Task<List<Competition>> GetCompetitionsLeaguesAsync()
        {
            ...
            return Task.Run<List<Competition>>(() =>
                base.Get<List<Competition>>("/v3/csgo/stats/{format}/Competitions", parameters)
            );
        }
        ...
        public Task<List<Game>> GetGamesByDateAsync(string date)
        {
            ...
            return Task.Run<List<Game>>(() =>
                base.Get<List<Game>>("/v3/csgo/stats/{format}/GamesByDate/{date}", parameters)
            );
        }
        ...
        public Task<List<Membership>> GetMembershipsActiveAsync()
        {
            ...
            return Task.Run<List<Membership>>(() =>
                base.Get<List<Membership>>("/v3/csgo/stats/{format}/ActiveMemberships", parameters)
            );
        }
        ...
        public Task<List<Membership>> GetMembershipsHistoricalAsync()
        {
            var parameters = new List<KeyValuePair<string, string>>();
            return Task.Run<List<Membership>>(() =>
                base.Get<List<Membership>>("/v3/csgo/stats/{format}/HistoricalMemberships", parameters)
            );
        }
        ...
        public Task<List<Membership>> GetMembershipsByTeamActiveAsync(int teamid)
        {
            ...
            return Task.Run<List<Membership>>(() =>
                base.Get<List<Membership>>("/v3/csgo/stats/{format}/MembershipsByTeam/{teamid}", parameters)
            );
        }
        ...
        public Task<List<Membership>> GetMembershipsByTeamHistoricalAsync(int teamid)
        {
            ...
            parameters.Add(new KeyValuePair<string, string>("teamid", teamid.ToString()));
            return Task.Run<List<Membership>>(() =>
                base.Get<List<Membership>>("/v3/csgo/stats/{format}/HistoricalMembershipsByTeam/{teamid}", parameters)
            );
        }
        ...
        public Task<Player> GetPlayerAsync(int playerid)
        {
            ...
            return Task.Run<Player>(() =>
                base.Get<Player>("/v3/csgo/stats/{format}/Player/{playerid}", parameters)
            );
        }
        ...
        public Task<List<Player>> GetPlayersAsync()
        {
            ...
            return Task.Run<List<Player>>(() =>
                base.Get<List<Player>>("/v3/csgo/stats/{format}/Players", parameters)
            );
        }
        ...
        public Task<List<Player>> GetPlayersByTeamAsync(int teamid)
        {
            ...
            parameters.Add(new KeyValuePair<string, string>("teamid", teamid.ToString()));
            return Task.Run<List<Player>>(() =>
                base.Get<List<Player>>("/v3/csgo/stats/{format}/PlayersByTeam/{teamid}", parameters)
            );
        }
        ...
        public Task<List<Game>> GetScheduleAsync(int roundid)
        {
            ...
            return Task.Run<List<Game>>(() =>
                base.Get<List<Game>>("/v3/csgo/stats/{format}/Schedule/{roundid}", parameters)
            );
        }
        ...
        public Task<List<SeasonTeam>> GetSeasonTeamsAsync(int seasonid)
        {
            ...
            return Task.Run<List<SeasonTeam>>(() =>
                base.Get<List<SeasonTeam>>("/v3/csgo/stats/{format}/SeasonTeams/{seasonid}", parameters)
            );
        }
        ...
        public Task<List<Team>> GetTeamsAsync()
        {
            ...
            return Task.Run<List<Team>>(() =>
                base.Get<List<Team>>("/v3/csgo/stats/{format}/Teams", parameters)
            );
        }
        ...
        public Task<List<Venue>> GetVenuesAsync()
        {
            ...
            return Task.Run<List<Venue>>(() =>
                base.Get<List<Venue>>("/v3/csgo/stats/{format}/Venues", parameters)
            );
        }
        ...
        public Task<List<Standing>> GetStandingsAsync(int roundid)
        {
            ...
            return Task.Run<List<Standing>>(() =>
                base.Get<List<Standing>>("/v3/csgo/stats/{format}/Standings/{roundid}", parameters)
            );
        }
