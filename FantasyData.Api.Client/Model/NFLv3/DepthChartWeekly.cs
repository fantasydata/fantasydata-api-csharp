...
{
    [DataContract(Namespace="", Name="DepthChartWeekly")]
    [Serializable]
    public partial class DepthChartWeekly
    {
        /// <summary>
        /// Unique ID of Depth Chart Weekly Record
        /// </summary>
        [Description("Unique ID of Depth Chart Weekly Record")]
        [DataMember(Name = "DepthChartWeeklyID", Order = 1)]
        public int DepthChartWeeklyID { get; set; }
