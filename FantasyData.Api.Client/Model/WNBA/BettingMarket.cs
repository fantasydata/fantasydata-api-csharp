...
namespace FantasyData.Api.Client.Model.WNBA
{
    ...
    public partial class BettingMarket
    {
        ...
        /// <summary>
        /// The unique ID of the team tied the betting market
        /// </summary>
        ...
        /// <summary>
        /// The abbreviation [Key] of the team associcated with this market (if applicable)
        /// </summary>
        ...
        /// <summary>
        /// A field that returns "Yes" if there are any available bets to make within the market in question. If there are no bets available to make, the field returns "No"
        /// </summary>
        ...
        /// <summary>
        /// Indicates whether a BettingOutcome has been archived or not. If Archived, that outcome is no longer available
        /// </summary>
        ...
        /// <summary>
        /// Indicates the URL that can be used to retrieve archived BettingOutcomes. An API Key and Sportsbook Grouping will be required to retrieve this information
        /// </summary>
