...
namespace FantasyData.Api.Client.Model.WNBA
{
    ...
    public partial class BettingEvent
    {
        ...
        /// <summary>
        /// The WNBA season of the game tied to the betting event
        /// </summary>
        ...
        /// <summary>
        /// The furthest forward time any sportsbook has a market set to close for this betting event
        /// </summary>
        ...
        /// <summary>
        /// A globally unique ID for the game tied to this event. This value is guaranteed to be unique across all sports/leagues.
        /// </summary>
        ...
        /// <summary>
        /// The status of the game in tied to this event. A list of WNBA game statuses can be found here
        /// </summary>
        ...
        /// <summary>
        /// The date and time that the game started (US Eastern Time)
        /// </summary>
