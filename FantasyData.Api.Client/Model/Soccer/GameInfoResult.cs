...
namespace FantasyData.Api.Client.Model.Soccer
{
    ...
    public partial class GameInfoResult
    {
        ...
        /// <summary>
        /// List of Alternate Market GameOdds from different sportsbooks (such as 1st-half, 1st-qtr, etc) with results
        /// </summary>
        [Description("List of Alternate Market GameOdds from different sportsbooks (such as 1st-half, 1st-qtr, etc) with results")]
