...
namespace FantasyData.Api.Client.Model.Soccer
{
    ...
    public partial class Headshot
    {
        ...
        /// <summary>
        /// The unique ID of the team associated with this player headshot
        /// </summary>
        ...
        /// <summary>
        /// The last updated timestamp of the player's hosted headshot
        /// </summary>
        ...
        /// <summary>
        /// The last updated timestamp of the player's transparent background hosted headshot
        /// </summary>
