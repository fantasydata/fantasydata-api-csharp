...
namespace FantasyData.Api.Client.Model.Lol
{
    ...
    public partial class PlayerStat
    {
        ...
        [DataMember(Name = "Deaths", Order = 7)]
        ...
        [DataMember(Name = "LargestKillingSpree", Order = 8)]
        ...
        [DataMember(Name = "LargestMultiKill", Order = 9)]
        ...
        [DataMember(Name = "KillingSpree", Order = 10)]
        ...
        [DataMember(Name = "LongestTimeSpentLiving", Order = 11)]
        ...
        [DataMember(Name = "DoubleKills", Order = 12)]
        ...
        [DataMember(Name = "TripleKills", Order = 13)]
        ...
        [DataMember(Name = "QuadraKills", Order = 14)]
        ...
        [DataMember(Name = "PentaKills", Order = 15)]
        ...
        [DataMember(Name = "UnrealKills", Order = 16)]
        ...
        [DataMember(Name = "TotalDamageDealt", Order = 17)]
        ...
        [DataMember(Name = "MagicDamageDealt", Order = 18)]
        ...
        [DataMember(Name = "PhysicalDamageDealt", Order = 19)]
        ...
        [DataMember(Name = "TrueDamageDealt", Order = 20)]
        ...
        [DataMember(Name = "TotalDamageDealtToChampions", Order = 22)]
        ...
        [DataMember(Name = "MagicDamageDealtToChampions", Order = 23)]
        ...
        [DataMember(Name = "PhysicalDamageDealtToChampions", Order = 24)]
        ...
        [DataMember(Name = "TrueDamageDealtToChampions", Order = 25)]
        ...
        [DataMember(Name = "TotalHeal", Order = 26)]
        ...
        [DataMember(Name = "TotalUnitsHealed", Order = 27)]
        ...
        [DataMember(Name = "TotalDamageTaken", Order = 28)]
        ...
        [DataMember(Name = "MagicDamageTaken", Order = 29)]
        ...
        [DataMember(Name = "PhysicalDamageTaken", Order = 30)]
        ...
        [DataMember(Name = "TrueDamageTaken", Order = 31)]
        ...
        [DataMember(Name = "GoldEarned", Order = 32)]
        ...
        [DataMember(Name = "GoldSpent", Order = 33)]
        ...
        [DataMember(Name = "TurretKills", Order = 34)]
        ...
        [DataMember(Name = "InhibitorKills", Order = 35)]
        ...
        [DataMember(Name = "TotalMinionsKilled", Order = 36)]
        ...
        [DataMember(Name = "NeutralMinionsKIlled", Order = 37)]
        ...
        [DataMember(Name = "NeutralMinionsKIlledTeamJungle", Order = 38)]
        ...
        [DataMember(Name = "NeutralMinionsKilledEnemyJungle", Order = 39)]
        ...
        [DataMember(Name = "TotalTimeCrowdControlDealt", Order = 40)]
        ...
        [DataMember(Name = "VisionWardsBoughtInGame", Order = 41)]
        ...
        [DataMember(Name = "SightWardsBoughtInGame", Order = 42)]
        ...
        [DataMember(Name = "WardsPlaced", Order = 43)]
        ...
        [DataMember(Name = "WardsKilled", Order = 44)]
        ...
        [DataMember(Name = "CombatPlayerScore", Order = 45)]
        ...
        [DataMember(Name = "ObjectivePlayerScore", Order = 46)]
        ...
        [DataMember(Name = "TotalPlayerScore", Order = 47)]
        ...
        [DataMember(Name = "FantasyPoints", Order = 48)]
