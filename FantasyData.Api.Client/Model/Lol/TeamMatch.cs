...
namespace FantasyData.Api.Client.Model.Lol
{
    ...
    {
        /// <summary>
        /// Team got first blood this match
        /// </summary>
        [Description("Team got first blood this match")]
        [DataMember(Name = "FirstBlood", Order = 1)]
        public decimal? FirstBlood { get; set; }

        /// <summary>
        /// Team got first tower this match
        /// </summary>
        [Description("Team got first tower this match")]
        [DataMember(Name = "FirstTower", Order = 2)]
        public decimal? FirstTower { get; set; }

        /// <summary>
        /// Team got first inhibitor this match
        /// </summary>
        [Description("Team got first inhibitor this match")]
        [DataMember(Name = "FirstInhibitor", Order = 3)]
        public decimal? FirstInhibitor { get; set; }

        /// <summary>
        /// Team got first baron this match
        /// </summary>
        [Description("Team got first baron this match")]
        [DataMember(Name = "FirstBaron", Order = 4)]
        public decimal? FirstBaron { get; set; }

        /// <summary>
        /// Team got first dragon this match
        /// </summary>
        [Description("Team got first dragon this match")]
        [DataMember(Name = "FirstDragon", Order = 5)]
        public decimal? FirstDragon { get; set; }

        /// <summary>
        /// Team got first rift herald this match
        /// </summary>
        [Description("Team got first rift herald this match")]
        ...
        [DataMember(Name = "TeamId", Order = 13)]
        ...
        [DataMember(Name = "LargestKillingSpree", Order = 19)]
        ...
        [DataMember(Name = "LargestMultiKill", Order = 20)]
        ...
        [DataMember(Name = "KillingSpree", Order = 21)]
        ...
        [DataMember(Name = "LongestTimeSpentLiving", Order = 22)]
        ...
        [DataMember(Name = "DoubleKills", Order = 23)]
        ...
        [DataMember(Name = "TripleKills", Order = 24)]
        ...
        [DataMember(Name = "QuadraKills", Order = 25)]
        ...
        [DataMember(Name = "PentaKills", Order = 26)]
        ...
        [DataMember(Name = "UnrealKills", Order = 27)]
        ...
        [DataMember(Name = "TotalDamageDealt", Order = 28)]
        ...
        [DataMember(Name = "MagicDamageDealt", Order = 29)]
        ...
        [DataMember(Name = "PhysicalDamageDealt", Order = 30)]
        ...
        [DataMember(Name = "TrueDamageDealt", Order = 31)]
        ...
        [DataMember(Name = "LargestCriticalStrike", Order = 32)]
        ...
        [DataMember(Name = "TotalDamageDealtToChampions", Order = 33)]
        ...
        [DataMember(Name = "MagicDamageDealtToChampions", Order = 34)]
        ...
        [DataMember(Name = "PhysicalDamageDealtToChampions", Order = 35)]
        ...
        [DataMember(Name = "TrueDamageDealtToChampions", Order = 36)]
        ...
        [DataMember(Name = "TotalHeal", Order = 37)]
        ...
        [DataMember(Name = "TotalUnitsHealed", Order = 38)]
        ...
        [DataMember(Name = "TotalDamageTaken", Order = 39)]
        ...
        [DataMember(Name = "MagicDamageTaken", Order = 40)]
        ...
        [DataMember(Name = "PhysicalDamageTaken", Order = 41)]
        ...
        [DataMember(Name = "TrueDamageTaken", Order = 42)]
        ...
        [DataMember(Name = "GoldEarned", Order = 43)]
        ...
        [DataMember(Name = "GoldSpent", Order = 44)]
        ...
        [DataMember(Name = "TurretKills", Order = 45)]
        ...
        [DataMember(Name = "InhibitorKills", Order = 46)]
        ...
        [DataMember(Name = "TotalMinionsKilled", Order = 47)]
        ...
        [DataMember(Name = "NeutralMinionsKIlled", Order = 48)]
        ...
        [DataMember(Name = "NeutralMinionsKIlledTeamJungle", Order = 49)]
        ...
        [DataMember(Name = "NeutralMinionsKilledEnemyJungle", Order = 50)]
        ...
        [DataMember(Name = "TotalTimeCrowdControlDealt", Order = 51)]
        ...
        [DataMember(Name = "VisionWardsBoughtInGame", Order = 52)]
        ...
        [DataMember(Name = "SightWardsBoughtInGame", Order = 53)]
        ...
        [DataMember(Name = "WardsPlaced", Order = 54)]
        ...
        [DataMember(Name = "WardsKilled", Order = 55)]
        ...
        [DataMember(Name = "CombatPlayerScore", Order = 56)]
        ...
        [DataMember(Name = "ObjectivePlayerScore", Order = 57)]
        ...
        [DataMember(Name = "TotalPlayerScore", Order = 58)]
        ...
        [DataMember(Name = "FantasyPoints", Order = 59)]
        ...
        [DataMember(Name = "TenKillsOrAssists", Order = 60)]
        ...
        [DataMember(Name = "Updated", Order = 61)]
        ...
        [DataMember(Name = "Games", Order = 62)]
        ...
        [DataMember(Name = "Matches", Order = 63)]
