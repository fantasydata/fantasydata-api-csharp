...
namespace FantasyData.Api.Client.Model.NHL
{
    ...
    public partial class BettingMarketSplit
    {
        ...
        /// <summary>
        /// The abbreviation [Key] of the team tied to this market split (if applicable)
        /// </summary>
        ...
        /// <summary>
        /// The name of the player tied to this split (if applicable)
        /// </summary>
