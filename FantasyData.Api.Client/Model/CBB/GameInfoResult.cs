...
namespace FantasyData.Api.Client.Model.CBB
{
    ...
    public partial class GameInfoResult
    {
        ...
        /// <summary>
        /// List of Alternate Market Pregame GameOdds from different sportsbooks with results
        /// </summary>
        [Description("List of Alternate Market Pregame GameOdds from different sportsbooks with results")]
