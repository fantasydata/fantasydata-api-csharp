...
namespace FantasyData.Api.Client.Model.CBB
{
    ...
    public partial class ScoreBasic
    {
        ...
        /// <summary>
        /// "The unique ID of the tournament Note: this is specific to the NCAA tournament & does not include other tournaments"
        /// </summary>
        ...
        [DataMember(Name = "TournamentID", Order = 12)]
        ...
        [DataMember(Name = "Bracket", Order = 13)]
        ...
        [DataMember(Name = "Round", Order = 14)]
        ...
        [DataMember(Name = "AwayTeamSeed", Order = 15)]
        ...
        [DataMember(Name = "HomeTeamSeed", Order = 16)]
        ...
        [DataMember(Name = "IsClosed", Order = 17)]
        ...
        [DataMember(Name = "GameEndDateTime", Order = 18)]
        ...
        [DataMember(Name = "AwayTeamScore", Order = 21)]
        ...
        [DataMember(Name = "HomeTeamScore", Order = 22)]
